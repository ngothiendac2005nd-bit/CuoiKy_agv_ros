...
def generate_launch_description():
    ...
    default_pbstream = os.path.join(pkg_root, 'maps', 'agv_mapcomplex_scan_cartographer_3d.pbstream')
    default_accumulated_state = os.path.join(pkg_root, 'maps', 'agv_mapcomplex_scan_cartographer_3d_accumulated.pkl')
    ...
    save_map_hint = LogInfo(
        msg=[
            '3D complex mapping: luu pbstream bang lenh ',
